...
/** 
 * @author 作者 jiagoushi: 
 * @date 创建时间：2023年11月11日 下午6:07:28 
 * @version 1.0 
 * @parameter 
 * @since 普通Web接口测试
 * @return 
...
@SpringBootTest(classes = SpringbootAutotestApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // 指定启动类和随机端口
